...
//  const showMenu = () => setVisible(true);
 ...
 // const [pesquisa, setPesquisa] = useState(''); 
  ...
  return (
    ...
    <View>
      <Text>HomeScreen - B7 Delivery</Text>

       <Button onPress={()=>navigation.navigate('Perfil'as never, {} as never)} title='Ver perfil'/>
       <Button onPress={()=>navigation.navigate('Sacola'as never, {} as never)} title='Sacola'/>
       <Button onPress={()=>navigation.navigate('Pedidos'as never, {} as never)} title='Meus pedidos'/>
    </View>
